...
Task `negation_scope` at `s64_d24_st150_ntr8192_nev512_b21`, 5 seeds, `n_params = 4769` on every arm. Journal `m3_quintuple_v2.jsonl` at commit `b8a9ace` (HEAD `b8a9ace`). Pre-registered reading: `M3_QUINTUPLE_PREREGISTERED_READING.md`. Produced by `scale/m3_quintuple.py --cells softmax glance settled twin argmax --seeds 0 1 2 3 4 --ks 8`.
