"""(copy of K1/chase/gpulock.py; only LAST moved to the K2 lane) House GPU lock: atomic mkdir of SP/phase_k/K1/gpu.lock.d, owner.txt inside, removed in finally.
...
LAST = SP + "/phase_k/K2/chase/.gpu_last_release"
GAP_S = 180
