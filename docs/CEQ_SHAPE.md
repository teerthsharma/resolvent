...
floor (13 of 40 cells violate it, `99777ab:V20_R15_THEORY_TABLE.md` §0.2). Every number here is an identity check, a price, or
a citation.
...
| P7 metric | position-matched NRMSE, cosine, residual with unit factors; McNemar on sign only | DERIVED | permuted oracle $W_1=0.0$ at NRMSE $1.421901$ (`99777ab:V20_R15_THEORY_TABLE.md:221`) | V-26, V-17 | — | — | KEEP (G2 plants) | — | REPAIR (§3.12 units) | REPAIR (item 18 McNemar) | both applied | — |
